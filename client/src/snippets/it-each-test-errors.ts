export const testCases = [
    {
        ...
        expectedErrors: ['Email is required', 'Please enter your password', 'Please confirm your password', 'You must agree to the terms and conditions'],
    },
    {
...
//     console.log(`Running test case for: ${name}`);
